...
<head>
    ...
    <title><?php echo ((isset($liveinfo['title']) && ($liveinfo['title'] !== ""))?($liveinfo['title']):$config['sitename']); ?></title>
    <link rel="stylesheet" type="text/css" href="/wxshare/Public/share/css/swiper.css">
    <link rel="stylesheet" type="text/css" href="/wxshare/Public/share/css/iconfont.css">
    <link rel="stylesheet" type="text/css" href="/wxshare/Public/share/css/style.css">

	<link href="/wxshare/Public/share/css/video-js.min.css" rel="stylesheet">
    <script type="text/javascript" src="/wxshare/Public/share/js/jquery-1.10.1.min.js"></script>
    <script type="text/javascript" src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
    <script type="text/javascript" src="/wxshare/Public/share/js/swiper.js"></script>
    <script type="text/javascript" src="/wxshare/Public/share/js/txbb-pop.js"></script>
    <script type="text/javascript" src="/wxshare/Public/share/js/template.js"></script> 
    <script type="text/javascript" src="/wxshare/Public/share/js/socket.io.js"></script> 
    <script type="text/javascript">
        var room_id = '<?php echo ($liveinfo['stream']); ?>';
        var to_uid = '<?php echo ($liveinfo['uid']); ?>';
        var User = <?php echo ($userinfoj); ?>;
        var level=<?php echo ($levellistj); ?>;
        var level_anchor=<?php echo ($levelanchorlistj); ?>;
		...
		var fly="";
        var videosrc='<?php echo ($hls); ?>';//<?php echo ($hls); ?>  //
		var livetype='<?php echo ($livetype); ?>';
        var myPlayer;
        var h=window.screen.height;
        var videotimer='',request='';
		var socket = new io("<?php echo ($configpri['chatserver']); ?>");
        ...
        function connectChange(){
					...
					if(livetype==0){
						if(videosrc){
							$("#videoPlay").show(); 
							var div='<button id="play"><img src="/wxshare/Public/share/images/play.png" width="61"></button>';
							$("#top_box").append(div);
							$("#state").hide();
							myPlayer.height(h);
							myPlayer.show()
	 ...
	 <script type="text/javascript" src="/wxshare/Public/share/js/eventListen.js"></script> 
</head>
<body>
...
<section class="section1">
    <article class="jwplayer jw-reset jw-stretch-fill">
        <div class="jw-media jw-reset">
            ...
            <div id="state" style="text-align:center;line-height:40px;position:absolute;top:35%;z-index:11;color:#fff;padding:20px;display:none;">
                <h2>
				<?php if($liveinfo['type'] == 1): ?>抱歉，这个房间是密码房间...
					<?php elseif($liveinfo['type'] > 1): ?>
						抱歉，这个房间是收费房间...
					<?php else: ?>
						抱歉，这个房间的主播已经退出房间啦...<?php endif; ?></h2>
            </div>
            <div class="jw-preview jw-reset" style="background-image: url('<?php echo ($liveinfo['avatar']); ?>')"></div>
        </div>
    </article>
    ...
    <article class="section1_box" id="section1_box">
        <header class="header clearfix">
            <div class="clearfix">
                <div class="userinfo">
                    <img src="<?php echo ($liveinfo['avatar_thumb']); ?>" userid="<?php echo ($liveinfo['goodnum']); ?>">
                    <span class="ulive"><?php echo ($liveinfo['user_nicename']); ?></span>
                    <span class="unum">房间号：<?php echo ($liveinfo['goodnum']); ?></span>
                </div>
                <div class="userimg" id="userimg">
                    <ul class="userpic clearfix" id="userpic"></ul>
                </div>

				<?php if($isattention == 1): ?><div class="user_followed on" type="1">
					已关注
				</div>
				<?php else: ?>
        ...
        <article class="chat_gift">
            ...
            <div class="chat_gift_send">
                <div class="balance"><a href="/wxshare/index.php/Share/pay">充值</a>：<span class="bglance_money"><?php echo ($userinfo['coin']); ?></span><span class="gift-coin"></span><span class="gift-bbar-text">></span> </div>
        ...
        <nav class="chat-tool">
            <ul>
                <li><img src="/wxshare/Public/share/images/talk.png" id="talk-btn"></li>
                <li><img src="/wxshare/Public/share/images/sentgift.png" id="gift-btn"></li>
                <li style="width:20%;text-align:left;display:none;">
                    <img src="/wxshare/Public/share/images/ic_room_flash_normal.png" id="more-btn">
                    <div class="more_list">
                ...
                <li style="float:right;">
                    <a href="/wxshare/index.php/Share/index">                        
						<img src="/wxshare/Public/share/images/ic_room_btn_close_pressed.png">
                    </a>
                </li>
            </ul>
        </nav>
        ...
        <article id="top_box" style="display: none;">
            <!-- <button id="play"><img src="/wxshare/Public/share/images/play.png" width="61"></button> -->
        </article>
	...
	<div class="down-bottom" onclick="downurl()">
		<img src="/wxshare/Public/share/images/down.png">
	</div>
    <!--排行版-->
...
<script id="ranklist" type="text/html">
    <article class="contributionval_content">
        ...
        <div class="contr_val"><img src="/wxshare/Public/share/images/me_ranking_yingpiao.png?v=1">(* wealth *)</div>
                    ...
                    (*if i <= 2*)
                        <li class="contr_one">
                            ...
                            <div class="contr_nickname">(*value.username*)
                                (*if value.sex == 1*)
                                <img class="sex1" src="/wxshare/Public/share/images/sex1.png"/>
                                (*else*)
                                <img class="sex1" src="/wxshare/Public/share/images/sex0.png"/>
                                (*/if*)
                                <img class="contr_lev" src="/wxshare/Public/share/images/level/public_icon_vip(*value.levelid*)@2x.png">
                            </div>
                ...
                <li class="clearfix">
                    ...
                    <div class="contr_ord_right">
                        ...
                        <a>(*value.username*) </a>
                            ...
                            <img class="sex1" src="/wxshare/Public/share/images/sex0.png"/>
                            (*/if*)
                        <img class="contr_lev" src="/wxshare/Public/share/images/level/public_icon_vip(*value.levelid*)@2x.png"></p>
...
<script id="userinfo" type="text/html">
    <div class="user_top clearfix"> 
        <button class="user_close"><img  src="/wxshare/Public/share/images/user_close.png"></button>
    </div>
    ...
    <div class="user_name">(*nickname*)
        ...
        <img class="sex1" src="/wxshare/Public/share/images/sex0.png"/>
        (*/if*)
        <img src="/wxshare/Public/share/images/level/public_icon_vip(*emceelevel*)@2x.png" width="30">
    </div>
    <div class="">
        ID: (*id*)
        <span>
        <img src="/wxshare/Public/share/images/user_dre.png">
        (*if city != ''*)
        (*province*)  (*city*)
        (*else*)
        火星
    ...
    <div class="user_authentication">
        <span class="sel"><img src="/wxshare/Public/share/images/sel.png"></span>
        认证：还没有哦
    </div>
    (*if intro !=null *)
...
<!--主播信息模板-->
<script type="text/javascript" src="/wxshare/Public/share/js/video.js"></script>
<script type="text/javascript" src="/wxshare/Public/share/js/videojs-contrib-hls.js"></script>


<script type="text/javascript" src="/wxshare/Public/share/js/common.js?t=1541744217"></script>
<script type="text/javascript" src="/wxshare/Public/share/js/iShare.js"></script>
<script type="text/javascript" src="/wxshare/Public/share/js/gift.js?t=1541744217"></script>
<script type="text/javascript" src="/wxshare/Public/share/js/jquery.md5.js"></script>
<script type="text/javascript" src="/wxshare/Public/share/js/login.js"></script>
