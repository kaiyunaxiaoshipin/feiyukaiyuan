...
class Api_User extends PhalApi_Api {
	...
	// /index.php?g=Appapi&m=Pay&a=erweimapay
        $list1[]=array('id'=>'19','name'=>'我的视频','thumb'=>get_upload_path("/public/appapi/images/personal/video.png"),'href'=>'' );
        //$list1[]=array('id'=>'2','name'=>'在线支付'/*.$configpub['name_coin']*/,'thumb'=>get_upload_path("/public/appapi/images/personal/coin.png") ,'href'=>get_upload_path('/index.php?g=Appapi&m=Pay&a=erweimapay'));
		if($shelves){
			$list1[]=array('id'=>'1','name'=>'我的收益','thumb'=>get_upload_path("/public/appapi/images/personal/votes.png"),'href'=>'' );
		
			$list2[]=array('id'=>'8','name'=>'在线客服','thumb'=>get_upload_path("/public/appapi/images/personal/icon-17.png") ,'href'=>get_upload_path("https://api.pop800.com/chat/619035"));
		}
		
		$list1[]=array('id'=>'2','name'=>'充值'.$configpub['name_coin'],'thumb'=>get_upload_path("/public/appapi/images/personal/coin.png") ,'href'=>get_upload_path('/index.php?g=Appapi&m=Pay&a=erweimapay'));
	...
	public function updateFields() {
        ...
        $allow=['user_nicename','sex','signature','birthday'];
		$domain = new Domain_User();
