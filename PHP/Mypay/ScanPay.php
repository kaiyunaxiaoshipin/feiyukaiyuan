...
if (empty($pay_id)&&empty($_POST['pay_id'])) exit('请输入您的平台ID，返回App点击“我的”页面获取。'); //唯一用户标识 不能为空 如果是登录状态可以直接取session中的ID或用户名
...
//二维码容错率决定你能遮挡多少部分
$user_data["logoShowTime"] = $user_data["qrcode_url"]?1:360*1000;
...
<div class="body">
    ...
    <div class="mod-ct">
        ...
        <div class="tps_btn" style="pointer-events: none">
