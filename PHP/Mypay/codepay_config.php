 ...
 */
$codepay_config['key'] = 'ckBMDvvmg5083084au2L672lsnsz';
 ...
 */
$codepay_config['page'] = 1; //支付页面展示方式

//支付页面风格样式 仅针对$codepay_config['page'] 参数为 1或2 才会有用。
$codepay_config['style'] = 2; //暂时保留的功能 后期会生效 留意官网发布的风格编号
...
//最低金额限制
$codepay_config['min'] = 1.00;

//启用支付宝官方接口 会员版授权后生效
$codepay_config['pay_type'] = 1;


$codepay_config[''] = ''; //这是默认的充值用户 因为我们演示的数据库充值 只有该用户名 如正式使用请为空
...
define('DB_USER', 'yunbao6');  //数据库用户名
define('DB_PWD', 'CCpBZeyTAayKe4bk');//数据库密码
define('DB_NAME', 'yunbao6');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'cmf_users');  //充值用户所在数据库表名
define('DB_USERMONEY', 'coin');  //充值用户所在表中的金额字段名
