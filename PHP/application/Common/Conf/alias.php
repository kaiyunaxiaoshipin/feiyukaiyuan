...
return array(
    ...
    //QQ第三方登录
		"QC" => SPAPP_PATH . 'Lib/Extend/qqApi/qqConnectAPI.class.php',
		//微博第三方登录
		"SaeTOAuthV2" => SPAPP_PATH . 'Lib/Extend/libweibo/saetv2.ex.class.php',
    // 分页类
    "Page" => SPAPP_PATH . 'Lib/Util/Page.class.php',
		
    "Page2" => SPAPP_PATH . 'Lib/Util/Page2.class.php',
