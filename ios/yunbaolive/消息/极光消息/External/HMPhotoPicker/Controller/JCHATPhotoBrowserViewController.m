...
- (void)viewDidLoad {
  [super viewDidLoad];
    ...
    self.topToolHeight.constant = 64+statusbarHeight;
    self.botToolHeight.constant = 45+ShowDiff;
  [self.navigationController setNavigationBarHidden:YES];
  self.navigationController.navigationBar.translucent = NO;
    topBar.backgroundColor = CellRow_Cor;
    bottomBar.backgroundColor = CellRow_Cor;
