...
@property (weak, nonatomic) IBOutlet UILabel *tupianL;
@property (weak, nonatomic) IBOutlet UILabel *weizhiL;
@property (weak, nonatomic) IBOutlet UILabel *yuyinL;
@property (weak, nonatomic) IBOutlet UILabel *paisheL;
